...
class UserProfileView extends StatefulWidget {
  const UserProfileView(
      {super.key, required this.myData, required this.userDataModel});
...
class _MainViewBodyState extends State<UserProfileView> {
  ...
  getUserPosts() async {
    await BlocProvider.of<GetUserProfilePostsCubit>(context)
        .getUserPosts(email: widget.userDataModel.email);
  }
      ...
      body: ModalProgressHUD(
        ...
        child: CustomScrollView(
          slivers: [
            ...
            BlocConsumer<GetUserProfilePostsCubit, GetUserProfilePostsState>(
